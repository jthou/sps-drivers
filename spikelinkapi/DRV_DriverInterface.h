...
public:
	...
	static DWORD GetDevicesInfoList(FT_DEVICE_LIST_INFO_NODE **pptDevicesInfo);
	static VOID ReleaseDevicesInfoList(FT_DEVICE_LIST_INFO_NODE *ptDevicesInfo);
    ...
    static DWORD EnumerateDevice(int8_t *deviceName[],int iDeviceNumMax, int *pDeviceNum);
    ...
    std::list<FT_DEVICE_LIST_INFO_NODE> m_devList;
    DWORD m_deviceNum;
};
